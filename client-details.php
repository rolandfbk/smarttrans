...
?>
<?php
	$sql="select * from customer_list where customer_list.ID=$id";
							...
							<div class="col-md-12">
							 <h2>Client Details</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "valid")
											echo "<h4 style='color:green;'>Client has been updated</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "invalid")
											echo "<h4 style='color:red;'>Failed to update client. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-tabs">
											<li class="active"><a href="#client-view" data-toggle="tab">Client Detail View</a>
											</li>
											<li class=""><a href="#client-edit" data-toggle="tab">Edit Client</a>
											</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="client-edit">
												...
												<br>
												<div class="col-md-6 col-sm-12 col-xs-12">
													<form action="<?php echo"client-detailsH.php?id=$id&cstmr=$company";?>" method="POST">
														...
														<div class="form-group">
															...
															<input type="text" name="postal" class="form-control" value="<?php echo"$postal"; ?>" onkeypress='validate(event)'/>
														</div>
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Update This Client</button>
														</div>
													</form>
												</div>
											</div>
