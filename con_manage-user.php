								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-tabs">
											...
											<li><a href="#controller-list" data-toggle="tab">Controller List</a>
											</li>-->
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="mobile">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_manage-mobile-userH.php" method="POST">
												...
												<div>
													<div class="panel panel-default">
														<!--<div class="panel-heading">
															 ...
															 <form action="con_export-mobile.php" method="post" name="export_excel">
																	...
																	<tbody>
																		<?php
																			while($row2 = mysqli_fetch_array($result2))
																			{
																				echo "
																					<tr>
																						<td><a href='con_mobile-details.php?id=$row2[ID]'><i class='fa fa-eye' style='font-size:20px'></i></a></td>
