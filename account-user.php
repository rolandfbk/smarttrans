							...
							<div class="col-md-12">
							 <h2>Account Users</h2>
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "valid")
											echo "<h4 style='color:green;'>New Account user has been created</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "invalid")
											echo "<h4 style='color:red;'>Failed to create new account user. Please try again...</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "delete")
											echo "<h4 style='color:green;'>Account user has been deleted</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "deletefail")
											echo "<h4 style='color:green;'>Failed to delete account user. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class="active"><a href="#controller-list" data-toggle="tab">Account User List</a>
											</li>
											<li class=""><a href="#controller" data-toggle="tab">Create Account User</a>
											</li>
										...
										<div class="tab-content">
											<div class="tab-pane fade" id="controller">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="account-userH.php" method="POST">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Create New Account User</button>
														</div>
													</form>
												</div>
											</div>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
																	<?php
																		$sql="select * from controller_user where controller_user.USER_TYPE='account' order by CREATED_AT desc";
																	...
																	<tbody>
																		<?php
																			while($row = mysqli_fetch_array($result))
																			{
																				echo "
																					<tr>
																						<td><a href='account-delete.php?id=$row[ID]' ";?> onclick="return confirm('Delete account user <?php echo"$row[FIRST_NAME] $row[SURNAME]"; ?>?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																						<td><a href='account-details.php?id=$row[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
