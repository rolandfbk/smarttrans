						...
						<div class="row">
							<div class="col-md-12">
							 <h2>Manage Assets</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "truckvalid")
											echo "<h4 style='color:green;'>Truck released</h4>";
												
								?>
							
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "truckinvalid")
											echo "<h4 style='color:red;'>Failed to release truck. Please try again...</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "trailervalid")
											echo "<h4 style='color:green;'>Trailer released</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "trailerinvalid")
											echo "<h4 style='color:red;'>Failed to release trailer. Please try again...</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "tankervalid")
											echo "<h4 style='color:green;'>Tanker released</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "tankerinvalid")
											echo "<h4 style='color:green;'>Failed to release tanker. Please try again...</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "tanker2valid")
											echo "<h4 style='color:green;'>Tanker released</h4>";
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade <?php if($tab=="1"){echo"active in";}?>" id="use-asset">
												<div class="panel panel-default">
														...
														<div id="buttons"></div>
														<div class="panel-body">
															<form action="unset-multiple.php" method="post">
																<div class="table-responsive">
																	...
																	<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example2">
																		...
																		<thead>
																			<tr>
																				<th style="width:40px;"><button type="submit" data-loading-text="Loading...">Release</button></th>
																				<th style="width:40px;"></th>
																				<th style="width:20px;">Status</th>
																				<th style="width:60px;">Work Order Number</th>
																				<th style="width:50px;">Vehicle Reg</th>
																		...
																		<tbody>
																			<?php
																				while($row2 = mysqli_fetch_array($result2))
																				{
																					...
																					echo "
																						<tr>
																							<td style='text-align:center'><input type='checkbox' name='users[]' value='$row2[VEHICLE_REG]'></td>
																							<td><a href='asset-check-truck.php?id=$row2[ID]' ><button>Release</button></a></td>";?>
																			<?php		
																					if($status2 == "repair")
																					{
																						echo"<td style='text-align:center'><img style='height:25px;width:25px;border-radius:25px;' src='assets/img/1.png'></td>";
																			...
																			<?php
																				...
																				while($row = mysqli_fetch_array($result))
																				{
																					...
																					echo "
																						<tr>
																							<td style='text-align:center'><input type='checkbox' name='users[]' value='$row[VEHICLE_REG]'></td>
																							<td><a href='asset-check-trailer.php?id=$row[ID]' ><button>Release</button></a></td>";?>
																			<?php		
																					if($status == "repair")
																					{
																						echo"<td style='text-align:center'><img style='height:25px;width:25px;border-radius:25px;' src='assets/img/1.png'></td>";
																			...
																			<?php
																				while($row8 = mysqli_fetch_array($result8))
																				{
																					...
																					echo "
																						<tr>
																							<td style='text-align:center'><input type='checkbox' name='users[]' value='$row8[VEHICLE_REG]'></td>
																							<td><a href='asset-check-trailer2.php?id=$row8[ID]' ><button>Release</button></a></td>";?>
																			<?php		
																					if($status8 == "repair")
																					{
																						echo"<td style='text-align:center'><img style='height:25px;width:25px;border-radius:25px;' src='assets/img/1.png'></td>";
																			...
																			<?php
																				...
																				while($row9 = mysqli_fetch_array($result9))
																				{
																					...
																					echo "
																						<tr>
																							<td style='text-align:center'><input type='checkbox' name='users[]' value='$row9[VEHICLE_REG]'></td>
																							<td><a href='asset-check-tanker.php?id=$row9[ID]' ><button>Release</button></a></td>";?>
																			<?php		
																					if($status9 == "repair")
																					{
																						echo"<td style='text-align:center'><img style='height:25px;width:25px;border-radius:25px;' src='assets/img/1.png'></td>";
																			...
																			<?php
																				while($row10 = mysqli_fetch_array($result10))
																				{
																					...
																					echo "
																						<tr>
																						<td style='text-align:center'><input type='checkbox' name='users[]' value='$row10[VEHICLE_REG]'></td>
																							<td><a href='asset-check-tanker2.php?id=$row10[ID]' ><button>Release</button></a></td>";?>
																			<?php		
																					if($status10 == "repair")
																					{
																						echo"<td style='text-align:center'><img style='height:25px;width:25px;border-radius:25px;' src='assets/img/1.png'></td>";
