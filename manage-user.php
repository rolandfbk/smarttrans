								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class=""><a href="#controller" data-toggle="tab">Create Controller User</a>
											</li>
											<li class="active"><a href="#controller-list" data-toggle="tab">Controller List</a>
											</li>
											<li class=""><a href="#mobile" data-toggle="tab">Create Mobile User</a>
											</li>
											<li class=""><a href="#mobile-list" data-toggle="tab">Mobile User List</a>
											</li>
											<li class=""><a href="#create-admin" data-toggle="tab">Create Admin User</a>
											</li>
											<li class=""><a href="#admin-list" data-toggle="tab">Administrator List</a>
											</li>
										</ul>
										...
										<div class="tab-content">
											<div class="tab-pane fade" id="controller">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="manage-userH.php" method="POST">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Create New Controller</button>
														</div>
													</form>
												</div>
											</div>
											<div class="tab-pane fade active in" id="controller-list">
												<br>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
																	<?php
																		$sql="select * from controller_user where controller_user.USER_TYPE='controller' order by CREATED_AT desc";
																	...
																	<thead>
																		<tr>
																			...
																			<th style="width:10px;"></th>
																			<th style="width:70px;">Controller ID</th>
																	...
																	<tbody>
																		<?php
																			while($row = mysqli_fetch_array($result))
																			{
																				echo "
																					<tr>
																						<td><a href='controller-delete.php?id=$row[ID]' ";?> onclick="return confirm('Delete controller <?php echo"$row[FIRST_NAME] $row[SURNAME]"; ?>?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																						<td><a href='controller-details.php?id=$row[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
											...
											<div class="tab-pane fade" id="mobile-list">
												<br>
											...
											<div class="tab-pane fade" id="create-admin">
												...
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="create-adminH.php" method="POST">
														<select name="create_admin" class="form-control">
															<option value="" disabled selected hidden>Please select user</option>
															<?php
																$sql4="select * from controller_user where controller_user.USER_TYPE='controller' order by CREATED_AT desc";
																$result4=ExecuteQuery($sql4);
																
																while($row4 = mysqli_fetch_array($result4))
																{
																	echo"<option value='$row4[EMAIL]'>$row4[FIRST_NAME] $row4[SURNAME]</option>";
																}
															?>
														</select>
											...
											<div class="tab-pane fade" id="admin-list">
												...
												<div>
													<div class="panel panel-default">
														<div class="panel-heading">
															 <!--<i class="fa fa-asterisk"></i>&nbsp;<b>Manage Work Orders</b>-->
															 <form action="export-admin.php" method="post" name="export_excel">
																<div class="control-group">
																	<div align="right" class="controls">
																		From (<i>Recent date</i>):
																		<input type="date" name="from" required="required">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example3">
																	<?php
																		$sql5="select * from controller_user where controller_user.USER_TYPE='admin' order by CREATED_AT desc";
																	...
																	<tbody>
																		<?php
																			while($row5 = mysqli_fetch_array($result5))
																			{
																				echo "
																					<tr>
																						<td><a href='admin-delete.php?id=$row5[ID]' ";?> onclick="return confirm('Delete Administrator <?php echo"$row5[FIRST_NAME] $row5[SURNAME]"; ?>?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																						<td><a href='admin-details.php?id=$row5[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
																						
																						<td>$row5[FIRST_NAME]</td>
																						<td>$row5[SURNAME]</td>
																						<td>$row5[EMAIL]</td>
																						<td>$row5[PHONE]</td>
																					</tr>
