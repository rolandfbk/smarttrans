								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class="active"><a href="#trailer2-list" data-toggle="tab">Trailer List</a>
											</li>
											<li class=""><a href="#trailer2" data-toggle="tab">Add New Trailer</a>
											</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade active in" id="trailer2-list">
												<br>
