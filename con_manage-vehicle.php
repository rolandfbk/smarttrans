										...
										<div class="tab-content">
											<div class="tab-pane fade" id="truck">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_manage-truckH.php" method="POST">
																			...
																			while($row = mysqli_fetch_array($result))
																			{
																				echo "
																					<tr>
																						...
																						<td><a href='con_truck-details.php?id=$row[ID]'><i class='fa fa-eye' style='font-size:20px'></i></a></td>
											...
											<div class="tab-pane fade" id="trailer">
												...
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_manage-trailerH.php" method="POST">
														<div class="form-group">
															<input type="text" name="vehicle_reg" class="form-control" placeholder="Vehicle registration number" required="required"/>
														</div>
														<div class="form-group">
																			...
																			while($row2 = mysqli_fetch_array($result2))
																			{
																				echo "
																					<tr>
																						...
																						<td><a href='con_trailer-details.php?id=$row2[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
											...
											<div class="tab-pane fade" id="trailer2">
												...
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_manage-trailer2H.php" method="POST">
														<div class="form-group">
															<input type="text" name="vehicle_reg" class="form-control" placeholder="Vehicle registration number" required="required"/>
														</div>
														<div class="form-group">
																			...
																			while($row5 = mysqli_fetch_array($result5))
																			{
																				echo "
																					<tr>
																						...
																						<td><a href='con_trailer2-details.php?id=$row5[ID]'><i class='fa fa-eye' style='font-size:20px'></i></a></td>
