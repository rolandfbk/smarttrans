							...
							<div class="col-md-12">
							 <h2>Manage First Tanker</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "trailervalid")
											echo "<h4 style='color:green;'>New Tanker has been added</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "trailerinvalid")
											echo "<h4 style='color:red;'>Failed to add new tanker. Please try again...</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "delete")
											echo "<h4 style='color:green;'>Tanker has been deleted</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "deletefail")
											echo "<h4 style='color:green;'>Failed to delete tanker. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class="active"><a href="#tanker-list" data-toggle="tab">Tanker List</a>
											</li>
											<li class=""><a href="#tanker" data-toggle="tab">Add New Tanker</a>
											</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="tanker">
												<br>
												
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="manage-tankerH.php" method="POST">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Add New Tanker</button>
														</div>
													</form>
												</div>
												
											</div>
											<div class="tab-pane fade active in" id="tanker-list">
												<br>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example2">
																	<?php
																		$sql2="select * from tanker order by CREATED_AT desc";
																	...
																	<tbody>
																		<?php
																			while($row2 = mysqli_fetch_array($result2))
																			{
																				echo "
																					<tr>
																						<td><a href='tanker-delete.php?id=$row2[ID]' ";?> onclick="return confirm('Delete this tanker?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
