				...
				<li class="text-center">
					...
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
                                <a href="con_delivery-point1.php">First Delivery Point</a>
                            </li>
						</ul>
                    </li>
            </div>
										...
										<div class="tab-content">
											<div class="tab-pane fade active in" id="client">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_clientH.php" method="POST">
											...
											<div class="tab-pane fade" id="pickup">
												...
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_pickup-pointH.php" method="POST">
														<div class="form-group">
											...
											<div class="tab-pane fade" id="delivery1">
												...
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_delivery-point1H.php" method="POST">
														<div class="form-group">
															<input type="text" name="offload_point" class="form-control" placeholder="Offload Point" required="required"/>
														</div>
														<div class="form-group">
