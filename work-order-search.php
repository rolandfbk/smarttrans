...
font-size: 16px;"> Welcome <?php echo $_SESSION["name"];?> &nbsp;<a href="index.php" class="btn btn-primary square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
						...
						<div class="row">
							<div class="col-md-5">
								<form action="work-order-searchH.php" method="POST" enctype="multipart/form-data">
							...
							<div class="col-md-5">
								...
								<form action="work-order-search-dateH.php" method="POST" enctype="multipart/form-data">
									<div class="form-group">
										<label>From</label>
