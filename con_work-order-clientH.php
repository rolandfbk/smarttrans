...
{
	header("location: con_work-order-create.php?client=$bill_client&type=$cargo_type");
}
else
{
	header("location: con_work-order-client.php?act=invalid&type=$cargo_type&client=$bill_client");
}
