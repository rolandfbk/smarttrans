...
$sql = "SELECT REFERENCE_NUMBER,FIRST_NAME,SURNAME,EMAIL,PHONE from controller_user WHERE (PRINT_FROM <= '$from' AND PRINT_FROM >= '$to') AND USER_TYPE='controller'";
$result1 = ExecuteQuery($sql);
...
header("Content-Disposition: attachment; filename=Controller-List.xls");
