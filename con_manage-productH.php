...
{
	header("location: con_manage-product.php?act=duplicate");
}
else
{
	...
	if($result2)
	{
		...
		header("location: con_manage-product.php?act=valid");
	}
	else
	{
		header("location: con_manage-product.php?act=invalid");
	}
}
