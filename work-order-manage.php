								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											...
											<form style="display:inline-block" action="sort-work-order.php" method="post" name="export_excel">
												<div class="control-group">
													<div class="controls">
														Sort by controller
											...
											<form style="display:inline-block;float:right" action="sort-color-work-order.php" method="post" name="export_excel">
												<div class="control-group">
													<div class="controls">
														Sort by color
										...
										<div class="panel-body">
											<div class="table-responsive">
												...
												<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
													...
													<thead>
														<tr>
															<th style="width:10px;"><!--<i class="fa fa-trash-o" style="font-size:20px"></i>--></th>
															<th style="width:10px;"><!--<i class="fa fa-eye" style="font-size:20px"></i>--></th>
													...
													<tbody>
														<?php
															...
															while($row = mysqli_fetch_array($result))
															{
																...
																echo "
																	<tr>
																		<td><a href='work-order-delete.php?id=$row[ID]'";?> onclick="return confirm('Delete Work Order <?php echo"$row[WORK_ORDER_NUMBER]";?>?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																		<td><a href='work-order-details.php?id=$row[ID]&truck=$row[TRUCK_ALLOCATION]&trailer=$row[TRAILER_ALLOCATION]&trailer2=$row[TRAILER_ALLOCATION_2]&tanker=$row[TANKER_ALLOCATION]&tanker2=$row[TANKER_ALLOCATION_2]'><i class='fa fa-eye' style='font-size:20px'></i></td>
																	";?>
															<?php		
																if($status == "pickedup")
																{
																		  ...
																		  <div class='modal-dialog' role='document'>
																			<div class='modal-content'>
																			  ...
																			  <div class='modal-body'>
																				...
																				<form style='display:inline-block' action='assign-driver.php?id=$row[ID]' method='post'>
																					<div class='control-group'>
																						<div class='controls'>
