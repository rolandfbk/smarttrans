								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "duplicate")
											echo "<h4 style='color:red;'>Client already exist.</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											...
											<li class=""><a href="#client" data-toggle="tab">Create Client</a>
											</li>
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="clientH.php" method="POST">
														<div class="form-group">
															<input type="text" name="accno" class="form-control" placeholder="Acc No" required="required"/>
														</div>
														<div class="form-group">
