										...
										<div class="tab-content">
																			...
																			<table>
																				...
																				else
																				{
																					echo"
																						<tr>
																							<th>Attachment</th>
																							<td>&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<a target='blank' href='$row5[FILE]'><i class='fa fa-file'></i></a>
																							</td>
																						</tr>
																					";
																				}
											...
											<div class="tab-pane fade" id="delivery-note">
												...
												<?php if($status == 'account')
													{
													?>
														<div align="right"><button style="width:150px" class="btn btn-danger" disabled>Send To Account</button></div>
												<?php
													}
													else{?>
												<div align="right"><a href="<?php echo"sent-to-account.php?id=$id";?>"><button style="width:150px" class="btn btn-danger">Send To Account</button></a></div>
												<?php }?>
												-->
