...
font-size: 16px;"> Welcome <?php echo $_SESSION["name"];?> &nbsp;<a href="index.php" class="btn btn-primary square-btn-adjust">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="acc_work-order-manage.php"><i class="fa fa-sitemap"></i> Work Orders</a>
                    </li>
					<li>
                        <a href="acc_work-order-search.php"><i class="fa fa-sitemap"></i> Search Work Order</a>
                    </li>
            </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
						...
						<div class="row">
							<div class="col-md-12">
							 <h2>Work Order Details&nbsp;&nbsp;&nbsp;&nbsp;
							 <!--
							 <?php if($status == 'account' && $pastel == "")
								{
								?>
									<a><button style="width:200px" class="btn btn-danger" disabled>Work Order Archived</button></a>
							<?php
								}
								else{?>
									<a href="<?php echo"acc_work-order-detailsH.php?id=$id";?>"><button style="width:200px" class="btn btn-danger">Archive This Work Order</button></a>
							<?php }?>
							 ...
							 -->
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "sendvalid")
											echo "<h4 style='color:green;'>Attachments sent</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "sendinvalid")
											echo "<h4 style='color:red;'>Failed to send attachments. Please try again...</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "editvalid")
											echo "<h4 style='color:green;'>Work Order Edited</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "editinvalid")
											echo "<h4 style='color:red;'>Failed to edit work order. Please try again...</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "pastelvalid")
											echo "<h4 style='color:green;'>Work Order sent to pastel</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "pastelinvalid")
											echo "<h4 style='color:red;'>Failed to send Work Order to pastel. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="tab nav nav-tabs" id="myTab">
											...
											<li><a href="#comments" role="tab" data-toggle="tab">Attachment</a>
											</li>
											<li><a href="#pickup" role="tab" data-toggle="tab">Pickup</a>
											</li>
											<li><a href="#stops" role="tab" data-toggle="tab">Stops</a>
											</li>
											<li><a href="#delivery" role="tab" data-toggle="tab">Delivery</a>
											</li>
											<?php if($status == 'delivered' || $status == 'mixed' || $status == 'account')
													{
														echo"<li><a href='#delivery-note' role='tab' data-toggle='tab'><b>Delivery Note</b></a></li>";
														echo"<li><a href='#process' role='tab' data-toggle='tab'><b>Process</b></a></li>";
													}
											?>
											...
											<?php if($status == 'created' || $status == 'pickedup' || $status == 'gatetime')
													{
														echo"<li><a href='#edit-work-order' role='tab' data-toggle='tab'><b>Edit This Work Order</b></a></li>";
													}
											?>
											<li><a href="#edit-work-order" role="tab" data-toggle="tab"><b><font color="#000">Edit This Work Order</font></b></a></li>
										</ul>
										...
										<div class="tab-content">
																...
																<table>
																	<tr>
																		...
																		else
																		{
																			...
																			//echo"<td style='padding-left:10px'><a href='$attachment' download='myimage'><button><i class='fa fa-file'></i>&nbsp;Download</button></a></td>";
											...
											<div class="tab-pane fade" id="delivery-note">
												...
												<a class="btn jquery-word-export" href="javascript:void(0)"><button style="" class="btn btn-primary">Download Delivery Note</button></a>
												<div id="page-content">
											...
											<div class="tab-pane fade" id="edit-work-order">
												...
												<form action="<?php echo "acc_edit-work-orderH.php?id=$id&truck=$truck&trailer=$trailer&trailer2=$trailer2&tanker=$tanker&tanker2=$tanker2&cl=$bill_client&tp=$type";?>" method="POST" enctype="multipart/form-data">
													<div class="row">
																...
																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group">
																			...
																			<input type="text" name="quantity1" class="form-control" value="<?php echo"$row8[QUANTITY_1]"; ?>">
																		</div>
																	</div>
																	<div class="col-md-6">
																		<div class="form-group">
																			<label>Quantity 2</label>
																			<input type="text" name="quantity2" class="form-control" value="<?php echo"$row8[QUANTITY_2]"; ?>">
																		</div>
																	</div>
																</div>
																<div class="form-group">
													...
													<div align="right">
														<?php
															if($status == "account" && $pastel == "pastel")
															{
																echo"<button type='submit' class='btn btn-danger' disabled>You Cannot Update this Work Order<br>It's Already Sent To Pastel</button>";
															}
															else{
																echo"<button type='submit' class='btn btn-primary'>Update Work Order</button>";
															}
														?>
											...
											<div class="tab-pane fade" id="process">
												...
												<br>
												<br>
												<?php if($pastel == 'pastel')
													{
													?>
														<div align="center"><button style="width:200px" class="btn btn-danger" disabled>Already Sent To Pastel</button></div>
												<?php
													}
													else{?>
														<div align="center"><button style="width:200px" class="btn btn-primary" id="btn-confirm">Send To Pastel</button></div>
												<?php }?>
												<br>
												<div align="center"><button style="width:200px" class="btn btn-success" id="btn-confirm2">Send Attachment</button></div>
												  ...
												  <div class="modal-dialog">
													<div class="modal-content">
													  <div class="modal-header">
														...
														<table>
															<tr>
																...
																<td style="padding-left:5px;vertical-align:top"><h4 class="modal-title" id="myModalLabel">I <b><?php echo"$_SESSION[name]";?></b>, confirm that the Work Order <b><?php echo"$work_order_number";?></b> is correct and all attachments verified.</h4></td>
															</tr>
														</table>
														...
														<div align="center">
															<table>
																<tr>
																	<td><input style="width:25px;height:25px" type="checkbox" id="myCheck"  onclick="myFunctionConfirm()"></td>
																	<td style="padding-left:5px"><b>Please Tick Here</b></td>
																</tr>
															</table>
													  ...
													  <div class="modal-footer">
														<a id="confirm" style="display:none" href="<?php echo"acc_sent-to-pastel.php?id=$id";?>"><button type="button" class="btn btn-success">NOW SEND TO PASTEL</button></a>
												...
												<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="mi-modal2">
												  <div class="modal-dialog">
													<div class="modal-content">
														<form action="<?php echo "acc_sendattachment.php?id=$id";?>" method="post">
													  <div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
														<br>
															...
															<table>
																<?php
																	if($mainattachment != "")
																	{
																		echo"
																		<tr>
																			<td><input style='width:25px;height:25px' type='checkbox' name='mainattachment' value='$mainattachment'></td>
																			<td><h4>&nbsp;&nbsp;&nbsp;Main Attachment &nbsp;&nbsp;&nbsp;&nbsp;<a target='blank' href='$mainattachment'><i style='width:25px;height:25px' class='fa fa-file'></i></a></h4></td>
																		</tr>";
																	}
																?>
																<?php
																	$sql31="select * from comment where comment.WORK_ORDER_NUMBER='$work_order_number' order by CREATED_AT desc";
																	$result31=ExecuteQuery($sql31);
																	
																	while($row31 = mysqli_fetch_array($result31))
																	{
																		if(strlen($row31['FILE']) > 30)
																		{
																			echo"
																				<tr>
																					<td><input style='width:25px;height:25px' type='checkbox' name='users[]' value='$row31[FILE]'></td>
																					<td><h4>&nbsp;&nbsp;&nbsp;Other Attachment &nbsp;&nbsp;&nbsp;&nbsp;<a target='blank' href='$row31[FILE]'><i style='width:25px;height:25px' class='fa fa-file'></i></a><h4></td>
																				</tr>
																			";
																		}
																	}
													  ...
													  <div class="modal-footer">
														<input type="email" name="email" class="form-control" style="width:250px" placeholder="Type email address" required="required">
														<button type="submit" class="btn btn-success">SEND ATTACHMENT</button>
														<!--<button type="button" class="btn btn-primary" id="modal-btn-no">CANCEL</button>-->
													  </div>
													  </form>
													</div>
