...
if($result2)
{
	...
	header("location: mob_work-order-details.php?id=$id&act=commentvalid");
}
else
{
	header("location: mob_work-order-details.php?id=$id&act=commentinvalid");
}
