						...
						<div class="row">
							<div class="col-md-12">
							 <h2>Work Orders</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "archivevalid")
											echo "<h4 style='color:green;'>Work Order Sent To Archive</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "archiveinvalid")
											echo "<h4 style='color:green;'>Failed to send work order to archive. Please try again...</h4>";
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
																	<?php
																		$sql="select * from work_order where STATUS='account' order by CREATED_AT desc";
																			...
																			while($row = mysqli_fetch_array($result))
																			{
																				...
																				echo "
																					<tr>
																						...
																						<td><a href='acc_work-order-details.php?id=$row[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
																					";
																				if($status == "pickedup")
																				{
