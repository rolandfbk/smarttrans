							...
							<div class="col-md-12">
							 <h2>Account User Details</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "valid")
											echo "<h4 style='color:green;'>Account user $reference_number has been updated</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "invalid")
											echo "<h4 style='color:red;'>Failed to update account user $reference_number. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-tabs">
											<li class="active"><a href="#controller-view" data-toggle="tab">Account User Detail View</a>
											</li>
											<li class=""><a href="#controller-edit" data-toggle="tab">Edit Account User</a>
											</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="controller-edit">
												...
												<br>
												<div class="col-md-6 col-sm-12 col-xs-12">
													<form action="<?php echo"account-user-detailsH.php?id=$id";?>" method="POST">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Update This Account User</button>
														</div>
													</form>
												</div>
											</div>
