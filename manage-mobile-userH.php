...
{
	header("location: mobile.php?act=duplicate");
}
else
{
	...
	$sql2=" INSERT INTO controller_user (REFERENCE_NUMBER,FIRST_NAME,SURNAME,EMAIL,PASSWORD,PHONE,USER_TYPE,CREATED_AT,UPDATED_AT,PRINT_FROM) values ('$orderNumber','$fn','$surname','$email','$password','$phone','mobile',now(),now(),now())";
	...
	if($result2)
	{
		...
		header("location: mobile.php?act=mobilevalid");
	}
	else
	{
		header("location: mobile.php?act=mobileinvalid");
	}
}
