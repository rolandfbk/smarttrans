								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class="active"><a href="#pickup-list" data-toggle="tab">Pickup Point List</a>
											</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="pickup">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="pickup-pointH.php" method="POST">
														...
														<div class="form-group">
															<input type="text" name="offload_point" class="form-control" placeholder="Pickup Point" required="required"/>
														</div>
														<div class="form-group">
											...
											<div class="tab-pane fade active in" id="pickup-list">
												<br>
																			...
																			while($row2 = mysqli_fetch_array($result2))
																			{
																				echo "
																					<tr>
																						...
																						<td><a href='pickup-point-details.php?id=$row2[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
