           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li>
                        <a class="active-menu" href="manage-product.php"><i class="fa fa-sitemap"></i> Manage Products</a>
                    </li>
										...
										<div class="tab-content">
											<div class="tab-pane fade" id="product">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="manage-productH.php" method="POST">
																	...
																	<tbody>
																		<?php
																			while($row = mysqli_fetch_array($result))
																			{
																				echo "
																					<tr>
																						<td><a href='product-delete.php?id=$row[ID]' ";?> onclick="return confirm('Delete this truck?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
