...
font-size: 16px;"> Welcome <?php echo $_SESSION["name"];?> &nbsp;<a href="index.php" class="btn btn-primary square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
						...
						<div class="row">
							<div class="col-md-12">
							 <h2>Manage Clients And Destinations</h2>
								<div align="right">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class="active"><a href="#client" data-toggle="tab">Create Client</a>
											</li>
											<li class=""><a href="#client-list" data-toggle="tab">Client List</a>
											</li>
											<li class=""><a href="#pickup" data-toggle="tab">Create Pickup Point</a>
											</li>
											<li class=""><a href="#pickup-list" data-toggle="tab">Pickup Point List</a>
											</li>
											<li class=""><a href="#delivery1" data-toggle="tab">Create Delivery Point 1</a>
											</li>
											<li class=""><a href="#delivery1-list" data-toggle="tab">Delivery Point 1 List</a>
											</li>
											<li class=""><a href="#delivery2" data-toggle="tab">Create Delivery Point 2</a>
											</li>
											<li class=""><a href="#delivery2-list" data-toggle="tab">Delivery Point 2 List</a>
											</li>
										</ul>
										...
										<div class="tab-content">
											<div class="tab-pane fade active in" id="client">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="clientH.php" method="POST">
														...
														<div class="form-group">
															<input type="text" name="province" class="form-control" placeholder="Province" required="required"/>
														</div>
														<div class="form-group">
												...
												<div>
													<div class="panel panel-default">
														<!--<div class="panel-heading">
															 ...
															 <form action="export-controller.php" method="post" name="export_excel">
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
																	<?php
																		$sql="select * from customer_list order by CREATED_AT desc";
																	...
																	<thead>
																		<tr>
																			...
																			<th style="width:70px;">Suburb</th>
																			<th style="width:70px;">City</th>
																			<th style="width:70px;">Province</th>
																			<th style="width:70px;">Country</th>
																			<th style="width:70px;">Postal Code</th>
																		</tr>
																	</thead>
																	<tbody>
																		<?php
																			while($row = mysqli_fetch_array($result))
																			{
																				echo "
																					<tr>
																						<td><a href='client-delete.php?id=$row[ID]'";?> onclick="return confirm('Delete Client?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																						<td><a href='client-details.php?id=$row[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
																						<td>$row[COMPANY]</td>
											...
											<div class="tab-pane fade" id="pickup">
												...
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="pickup-pointH.php" method="POST">
														<div class="form-group">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Create New Pickup Point</button>
														</div>
													</form>
												</div>
												
											</div>
											<div class="tab-pane fade" id="pickup-list">
												<br>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example2">
																	<?php
																		$sql2="select * from pickup_point order by CREATED_AT desc";
																	...
																	<tbody>
																		<?php
																			while($row2 = mysqli_fetch_array($result2))
																			{
																				echo "
																					<tr>
																						<td><a href='pickup-delete.php?id=$row2[ID]' ";?> onclick="return confirm('Delete pickup point?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																						<td>$row2[OFFLOAD_POINT]</td>
																						<td>$row2[POSTAL_CODE]</td>
											...
											<div class="tab-pane fade" id="delivery2">
												...
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="delivery-point2H.php" method="POST">
														<div class="form-group">
															<input type="text" name="offload_point" class="form-control" placeholder="Offload Point" required="required"/>
														</div>
														<div class="form-group">
											...
											<div class="tab-pane fade" id="delivery2-list">
												<br>
																	...
																	<tbody>
																		<?php
																			while($row3 = mysqli_fetch_array($result3))
																			{
																				echo "
																					<tr>
																						<td><a href='delivery2-delete.php?id=$row3[ID]'";?> onclick="return confirm('Delete delivery point 2?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
											...
											<div class="tab-pane fade" id="delivery1">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="delivery-point1H.php" method="POST">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Create New Delivery Point 1</button>
														</div>
													</form>
												</div>
											</div>
											<div class="tab-pane fade" id="delivery1-list">
												<br>
