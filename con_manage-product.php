           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li>
                        <a class="active-menu" href="con_manage-product.php"><i class="fa fa-sitemap"></i> Manage Products</a>
                    </li>
							...
							<div class="col-md-12">
							 <h2>Manage Products</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "valid")
											echo "<h4 style='color:green;'>New Product has been added</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "invalid")
											echo "<h4 style='color:red;'>Failed to add new product. Please try again...</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "productdelete")
											echo "<h4 style='color:green;'>Product has been deleted</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "productdeletefail")
											echo "<h4 style='color:green;'>Failed to delete product. Please try again...</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "duplicate")
											echo "<h4 style='color:red;'>This product is already in the list</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											...
											<li class=""><a href="#product" data-toggle="tab">Add New Product</a>
											</li>
										...
										<div class="tab-content">
											<div class="tab-pane fade" id="product">
												...
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="con_manage-productH.php" method="POST">
															...
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
																	...
																	<thead>
																		<tr>
																			<th style="width:5%;"></th>
																			<th style="width:95%;">Product Name</th>
																		</tr>
																	</thead>
																	<tbody>
																		<?php
																			while($row = mysqli_fetch_array($result))
																			{
																				echo "
																					<tr>
																						<td><a href='con_product-delete.php?id=$row[ID]' ";?> onclick="return confirm('Delete this truck?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
