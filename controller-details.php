							...
							<div class="col-md-12">
							 <h2>Controller Details</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "valid")
											echo "<h4 style='color:green;'>Controller $reference_number has been updated</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "invalid")
											echo "<h4 style='color:red;'>Failed to update controller $reference_number. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-tabs">
											<li class="active"><a href="#controller-view" data-toggle="tab">Controller Detail View</a>
											</li>
											<li class=""><a href="#controller-edit" data-toggle="tab">Edit Controller</a>
											</li>
										...
										<div class="tab-content">
											<div class="tab-pane fade active in" id="controller-view">
												<br>
											...
											<div class="tab-pane fade" id="controller-edit">
												<br>
												
												<br>
												<div class="col-md-6 col-sm-12 col-xs-12">
													<form action="<?php echo"controller-detailsH.php?id=$id";?>" method="POST">
														...
														<div class="form-group">
															...
															<input type="text" name="password" class="form-control" placeholder="Type here only if necessary"/>
														</div>
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Update This Controller</button>
														</div>
													</form>
												</div>
											</div>
