...
?>
<?php
	$sql="select * from trailer where trailer.ID=$id";
							...
							<div class="col-md-12">
							 <h2>Trailer Details</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "valid")
											echo "<h4 style='color:green;'>Trailer $vehicle_reg $vehicle_make has been updated</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "invalid")
											echo "<h4 style='color:red;'>Failed to update trailer $vehicle_reg $vehicle_make. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-tabs">
											<li class="active"><a href="#trailer-view" data-toggle="tab">Trailer Detail View</a>
											</li>
											<li class=""><a href="#trailer-edit" data-toggle="tab">Edit Trailer Details</a>
											</li>
										...
										<div class="tab-content">
											<div class="tab-pane fade active in" id="trailer-view">
												<br>
											...
											<div class="tab-pane fade" id="trailer-edit">
												<br>
												
												<br>
												<div class="col-md-6 col-sm-12 col-xs-12">
													<form action="<?php echo"trailer-detailsH.php?id=$id";?>" method="POST">
														...
														<div class="form-group">
															<label>Vin No</label>
															<input type="test" name="vin_no" class="form-control" value="<?php echo"$vin_no"; ?>" />
														</div>
														<br>
														<div class="form-group">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Update This Trailer</button>
														</div>
													</form>
												</div>
											</div>
