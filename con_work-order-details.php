								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="tab nav nav-tabs" id="myTab">
											<li class="active"><a href="#header" role="tab" data-toggle="tab">Header</a>
											</li>
											...
											<?php 
												if($delivery_point2 =='')
												{
													if($status == 'delivered' || $status == 'mixed' || $status == 'account')
													{
													...
													if($status == 'mixed' || $status == 'account')
													{
														echo"<li class=''><a href='#delivery-note' role='tab' data-toggle='tab'><b>Delivery Note</b></a></li>";
														echo"<li><a href='#process' role='tab' data-toggle='tab'><b>Process</b></a></li>";
													}
											...
											<?php if($status == 'created' || $status == 'pickedup' || $status == 'gatetime')
													{
														echo"<li class=''><a href='#edit-work-order' data-toggle='tab'><b>Edit This Work Order</b></a></li>";
													}
											?>
										</ul>
										...
										<div class="tab-content">
													...
													<div class="col-md-4 col-sm-12 col-xs-12">
														<?php
															...
															echo "
																<table>
																	<tr>
																		...
																		{
																			//echo"<td style='padding-left:10px'><a target='blank' href='$attachment'><i class='fa fa-file'></i></a></td>";
															...
															echo"	</tr>
																	...
																	<tr style='height:10px'></tr>
																	<tr>
																		<th style='width:190px;text-align:right'>Container Number&nbsp;&nbsp;&nbsp;:</th>
																		<td style='padding-left:10px'>$container_number</td>
																	</tr>
																	<tr style='height:10px'></tr>
																	<tr>
											...
											<div class="tab-pane fade" id="comments">
												...
												<div class="col-md-12 col-sm-12 col-xs-12">
													<form action="<?php echo"con_commentH.php?id=$id";?>" method="POST" enctype="multipart/form-data">
													<!--  Start Table -->
													<div class="panel panel-default">
														...
														<?php
															...
															while($row16 = mysqli_fetch_array($result16))
															{
																echo"
																	<tr>
																		<td>";
																			if($row16['COMMENT'] == 'Diesel stop' || $row16['COMMENT'] == 'Vehicle check' || $row16['COMMENT'] == 'Vehicle breakdown' || $row16['COMMENT'] == 'Rest' || $row16['COMMENT'] == 'Puncture')
																			{
																				echo"<font color='red'><b>$row16[COMMENT]</b></font>";
																			}
																			else{
																				echo"$row16[COMMENT]";
																			}
											...
											<div class="tab-pane fade" id="edit-work-order">
												...
												<form action="<?php echo "con_edit-work-orderH.php?id=$id&truck=$truck&trailer=$trailer&trailer2=$trailer2&tanker=$tanker&tanker2=$tanker2&cl=$bill_client&tp=$type";?>" method="POST" enctype="multipart/form-data">
													<div class="row">
																...
																<?php if($type == 'Packed')
																	{
																		echo"
																			<div class='form-group'>
																				...
																				<input type='text' name='container_number' class='form-control' value='$row8[CONTAINER_NUMBER]'>
																			</div>
																		";
																	}
																?>
														...
														<div class="col-md-3 col-sm-12 col-xs-12">
															<div class="form-group">
																...
																<div class="form-group">
																	...
																	<input type="text" name="quantity" class="form-control" value="<?php echo"$row8[QUANTITY]"; ?>" onkeypress='validate(event)'>
																</div>
																<div class="form-group">
																	<label>Tonnage</label>
																	<input type="text" name="tonnage" class="form-control" value="<?php echo"$row8[TONNAGE]"; ?>" onkeypress='validate(event)'>
																</div>
																<div class="form-group">
																	...
																	<select name="pickup_point" class="form-control">
																		...
																		<?php
																			$sql22="select * from pickup_point order by CUSTOMER_NAME";
											...
											<div class="tab-pane fade" id="process">
												...
												<?php if($status == 'account')
													{
													?>
														<div align="center"><button style="" class="btn btn-danger" disabled>Already Sent To Account</button></div>
												<?php
													}
													else{?>
												<div align="center"><a href="<?php echo"con_sent-to-account.php?id=$id";?>"><button style="width:150px" class="btn btn-danger">Send To Account</button></a></div>
												<?php }?>
											</div>
