																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example4">
																	...
																	<thead>
																		<tr>
																			...
																			<th style="width:60px;">Cargo Type</th>
																		</tr>
																	</thead>
																	<tbody>
																		<?php
																			while($row4 = mysqli_fetch_array($result4))
																			{
																				echo "
																					<tr>
																						<td><a href='con_delivery-point1-details.php?id=$row4[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
																						<td>$row4[COMPANY]</td>
