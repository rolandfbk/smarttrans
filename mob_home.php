    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="mob_home.php">Smart Barter</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="mob_home.php"><i class="fa fa-home"></i> Home</a>
                    </li>
					<li>
                        <a href="mob_work-orders.php"><i class="fa fa-sitemap"></i> Work Orders</a>
                    </li>
            </div>
