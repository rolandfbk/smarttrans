						...
						<div class="row">
							<div class="col-md-12">
							 <h2>Archive Work Orders</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "returnvalid")
											echo "<h4 style='color:green;'>Work Order Returned to Account</h4>";
												
								?>
								
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "returninvalid")
											echo "<h4 style='color:green;'>Failed to return work order to account. Please try again...</h4>";
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
																	<?php
																		$sql="select * from work_order where WORK_ORDER_NUMBER='$id' and STATUS='archive' order by CREATED_AT desc";
																			...
																			while($row = mysqli_fetch_array($result))
																			{
																				...
																				echo "
																					<tr>
																						...
																						<td><a href='acc_work-order-details-search.php?id=$row[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
																					";
																				if($status == "pickedup")
																				{
