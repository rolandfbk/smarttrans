							...
							<div class="col-md-12">
							 <h2>Manage Second Tanker</h2>   
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "trailer2valid")
											echo "<h4 style='color:green;'>New Second Tanker has been added</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "trailer2invalid")
											echo "<h4 style='color:red;'>Failed to add new second tanker. Please try again...</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "delete2")
											echo "<h4 style='color:green;'>Second Tanker has been deleted</h4>";
								...
								<?php
									if (isset ($_GET["act"]))
										if ($_GET["act"] == "delete2fail")
											echo "<h4 style='color:green;'>Failed to delete second tanker. Please try again...</h4>";
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class="active"><a href="#tanker2-list" data-toggle="tab">Tanker List</a>
											</li>
											<li class=""><a href="#tanker2" data-toggle="tab">Add New Tanker</a>
											</li>
										...
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="tanker2">
												<br>
												
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="manage-tanker2H.php" method="POST">
														...
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Add New Second Tanker</button>
														</div>
													</form>
												</div>
											</div>
											<div class="tab-pane fade active in" id="tanker2-list">
												<br>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example4">
																	<?php
																		$sql5="select * from tanker_2 order by CREATED_AT desc";
																	...
																	<tbody>
																		<?php
																			while($row5 = mysqli_fetch_array($result5))
																			{
																				echo "
																					<tr>
																						<td><a href='tanker2-delete.php?id=$row5[ID]' ";?> onclick="return confirm('Delete this tanker?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
