...
if($url == "attachment/$time")
{
	...
	if($result2)
	{
		...
		header("location: con_work-order-details.php?id=$id&act=editvalid");
	}
	else
	{
		header("location: con_work-order-details.php?id=$id&act=editinvalid");
	}
}
else
{
