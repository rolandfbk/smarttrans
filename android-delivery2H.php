...
$sql2=" INSERT INTO delivery2 (WORK_ORDER_NUMBER,DATE,TIME,SIGNED_BY,SIGNATURE,DELIVERED_BY,CREATED_AT) values ('$orderNumber','$delivery_date','$delivery_time','$signed_by','$url','$user',now())";
...
if($result2)
{
	...
	$sql4=" INSERT INTO activity_log (WORK_ORDER_NUMBER,COMMENT,TIME,SYSTEM_TIME,USER,CREATED_AT) values ('$orderNumber','second delivery confirmation','$delivery_time',now(),'$user',now())";
	$result4=ExecuteNonQuery ($sql4);
	
	$sql5="update work_order set STATUS='mixed',QUANTITY_2=$quantity, DELIVERED_AT=now() where work_order.WORK_ORDER_NUMBER='$orderNumber'";
