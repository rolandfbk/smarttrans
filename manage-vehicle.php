								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="nav nav-pills">
											<li class=""><a href="#truck" data-toggle="tab">Add New Truck</a>
											</li>
											<li class="active"><a href="#truck-list" data-toggle="tab">Truck List</a>
											</li>
											<li class=""><a href="#trailer" data-toggle="tab">Add New Trailer</a>
											</li>
											<li class=""><a href="#trailer-list" data-toggle="tab">Trailer List</a>
											</li>
											<li class=""><a href="#trailer2" data-toggle="tab">Add New Trailer 2</a>
											</li>
											<li class=""><a href="#trailer2-list" data-toggle="tab">Trailer 2 List</a>
											</li>
											<li class=""><a href="#asset" data-toggle="tab">Assets Check</a>
											</li>
										</ul>

										<div class="tab-content">
											<div class="tab-pane fade" id="truck">
												<br>
												
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="manage-truckH.php" method="POST">
														<div class="form-group">
															<input type="text" name="vehicle_reg" class="form-control" placeholder="Vehicle registration number" required="required"/>
														</div>
														<div class="form-group">
															<input type="text" name="vehicle_fleet_no" class="form-control" placeholder="Vehicle fleet number" required="required"/>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div id="sandbox-container"><input name="expiry_date" type="text" class="form-control" placeholder="Click to set date" required="required"/></div>
														</div>
														<div class="form-group">
															<input type="text" maxlength="4" name="model_year" class="form-control" placeholder="Model year" onkeypress='validate(event)' required="required"/>
														</div>
											...
											<div class="tab-pane fade active in" id="truck-list">
												<br>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example">
																	<?php
																		$sql="select * from truck order by CREATED_AT desc";
																	...
																	<thead>
																		<tr>
																			...
																			<th style="width:100px;">Vehicle Fleet Number</th>
																	...
																	<tbody>
																		<?php
																			while($row = mysqli_fetch_array($result))
																			{
																				echo "
																					<tr>
																						<td><a href='truck-delete.php?id=$row[ID]' ";?> onclick="return confirm('Delete this truck?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																						<td><a href='truck-details.php?id=$row[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
																						<td>$row[VEHICLE_REG]</td>
																						<td>$row[VEHICLE_FLEET_NO]</td>
											...
											<div class="tab-pane fade" id="trailer-list">
												<br>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example3">
																	<?php
																		$sql3="select * from trailer order by CREATED_AT desc";
																		$result3=ExecuteQuery($sql3);
																		
																		$sql4="select * from truck order by CREATED_AT desc";
											...
											<div class="tab-pane fade" id="trailer2">
												<br>
												
												<br>
												<div class="col-md-4 col-sm-12 col-xs-12">
													<form action="manage-trailer2H.php" method="POST">
														<div class="form-group">
															<input type="text" name="vehicle_reg" class="form-control" placeholder="Vehicle registration number" required="required"/>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															<label>Expiry date</label>
															<div id="sandbox-container3"><input name="expiry_date" type="text" class="form-control" placeholder="Click to set date" required="required"/></div>
														</div>
														
														<br>
														<div>
															<button type="submit" class="btn btn-primary">Add New Second Trailer</button>
														</div>
													</form>
												</div>
											</div>
											<div class="tab-pane fade" id="trailer2-list">
												<br>
														...
														<div class="panel-body">
															<div class="table-responsive">
																...
																<table class="table table-striped table-bordered table-hover" style="table-layout:fixed" id="dataTables-example4">
																	<?php
																		$sql5="select * from trailer_2 order by CREATED_AT desc";
																	...
																	<tbody>
																		<?php
																			while($row5 = mysqli_fetch_array($result5))
																			{
																				echo "
																					<tr>
																						<td><a href='trailer2-delete.php?id=$row5[ID]' ";?> onclick="return confirm('Delete this trailer?')"<?php echo"><i class='fa fa-trash-o' style='font-size:20px;color:red'></i></a></td>
																						<td><a href='trailer2-details.php?id=$row5[ID]' ><i class='fa fa-eye' style='font-size:20px'></i></a></td>
