									...
									<div class="panel-body">
										...
										<div class="tab-content">
																			...
																			while($row = mysqli_fetch_array($result))
																			{
																				...
																				echo "
																					<tr>
																						...
																						<td><a href='work-order-details.php?id=$row[ID]&truck=$row[TRUCK_ALLOCATION]&trailer=$row[TRAILER_ALLOCATION]&trailer2=$row[TRAILER_ALLOCATION_2]'><i class='fa fa-eye' style='font-size:20px'></i></td>
																					";?>
																			<?php		
																				if($status == "pickedup")
																				{
											...
											<div class="tab-pane fade active in" id="create-work-order">
												<br>
												<form action="create-work-orderH.php" method="POST" enctype="multipart/form-data">
												<div class="row">
																	...
																	<tbody>
																		<?php
																			while($row1 = mysqli_fetch_array($result1))
																			{
																				...
																				echo "
																					<tr>
																						<td><a href='work-order-details.php?id=$row1[ID]'><i class='fa fa-eye' style='font-size:20px'></i></a></td>
																					";?>
